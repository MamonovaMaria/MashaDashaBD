...
#    а студентов, не сдавших экзамены, скопировать в таблицу Студенты_отчисление. (поняли это как: оценки тольок 2)
...
#__________________________________________________________________________________________________________________________________________
#7. Из таблицы Студенты_2017 удалить студентов 13 группы.
delete from students_2017 where group_num = 13;
...
add constraint department foreign key (department) references departments(dep_num);
